...
public class SummaryReport {
    ...
    public SummaryReport(String opening_date, String closing_date) throws JSONException {
        ...
        this.apl_data = getAPLProcData(apl_filename,"apl");
        this.proc_data = getAPLProcData(proc_filename,"proc");


    }

    public HashMap<String, JSONObject> getAPLProcData(String req_file, String type) throws JSONException {
        ...
        try {
            ...
            try {
                reader = new BufferedReader(new FileReader(req_file));
                String line= null;
                String temp_headers = reader.readLine();
                if(temp_headers==null){
                    return null;
                }
                List<String> opening_headers = Arrays.asList(temp_headers.split("\\s*,\\s*"));
                while((line=reader.readLine())!=null){
                    ...
                    value.put("vs_ref", record.getString("vs_ref"));
                    value.put("location", record.getString("location"));
                    data_map.put(record.getString("component_id"),value);
